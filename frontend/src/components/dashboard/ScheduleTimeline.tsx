        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {items.map((item) => (
              <div
                key={item.id}
                className="relative rounded-2xl border border-[var(--border)] bg-[var(--card-hover)] px-4 py-3 before:absolute before:right-0 before:top-0 before:h-full before:w-1 before:rounded-r-2xl before:bg-[linear-gradient(180deg,var(--accent-soft),var(--accent))] before:content-['']"
              >
