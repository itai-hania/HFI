...
export function Tabs({
  ...
  return (
    <div className="inline-flex rounded-2xl border border-[var(--border)] bg-[var(--card)] p-1" role="tablist" aria-label="Queue tabs">
      {tabs.map((tab) => (
        <button
          key={tab.key}
          type="button"
          ...
          className={cn(
            ...
            active === tab.key
              ? "bg-[var(--accent)] text-[var(--accent-ink)] shadow-[0_8px_24px_rgba(236,72,153,0.28)]"
